...
namespace APIGATEWAY_SDK
{
    ...
    public partial class Signer
    {
        ...
        public HttpWebRequest Sign(HttpRequest r)
        {
            ...
            if (r.host.ToString().StartsWith("https", StringComparison.OrdinalIgnoreCase))
            {
                req = WebRequest.Create(r.host + r.uri + queryString) as HttpWebRequest;
            ...
            {
                req = (HttpWebRequest)WebRequest.Create(r.host + r.uri + queryString);
            }
